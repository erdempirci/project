const products = [
  {icon:'SR',name:'ShipReady',status:'Active',group:'active',category:'Marine AI',availability:'Ürün geliştirme aktif',summary:'Teknik ekiplerin proje hazırlığı ve operasyon takibini tek yerde hızlandırır.',desc:'Yacht / shipbuilding ekipleri için AI destekli teknik hazırlık ve proje operasyon ürünü.',detail:'Teknik ekiplerin proje hazırlığı, doküman takibi ve operasyon akışını hızlandırmak için geliştirilen marine odaklı ürün.',primary:null,secondary:null},
  ...
  {icon:'SF',name:'SchoolFlow AI',status:'Live demo',group:'active',category:'Education AI',availability:'Vercel production • canlı',summary:'Ders programı çakışmalarını azaltır ve öğretmen uygunluğu / görevlendirmesini AI ile kolaylaştırır.',desc:'AI destekli okul ders programı, çakışma önleme ve akıllı öğretmen görevlendirme platformu.',detail:'Okul operasyonlarında ders programı, öğretmen uygunluğu, çakışma önleme, vekalet ve devamsızlık işlerini otomatikleştirmeye odaklanan çalışan prototip. Production demo Vercel üzerinde çalışıyor.',primary:['Canlı demoyu aç','https://schoolflow-ai.vercel.app'],secondary:null},
  {icon:'ST',name:'SpoolTrack',status:'Live demo',group:'active',category:'Marine Ops',availability:'Vercel production • canlı',summary:'Spool ve ISO üretimini zone, sistem, revizyon ve durum bazında sahadan takip eder.',desc:'Mekanik imalat için mobil odaklı spool / ISO üretim takip sistemi.',detail:'React, Vite ve Firebase altyapısıyla geliştirilen SpoolTrack; mekanik üretim ilerlemesini sistem, zone, spool ve ISO bazında takip etmek üzere tasarlandı. PWA desteği sayesinde mobil cihazda uygulama benzeri kullanılabilir.',primary:['Canlı demoyu aç','https://boru-takip.vercel.app'],secondary:null},
  ...
  {icon:'CA',name:'CulinaryAI',status:'Live demo',group:'active',category:'Food AI',availability:'Vercel production • canlı',summary:'Evdeki malzemelerden yemek fikri üretir ve alışveriş listesini daha akıllı hale getirir.',desc:'Akıllı buzdolabı asistanı: mevcut malzemelerden yemek önerileri ve alışveriş desteği.',detail:'CulinaryAI, evdeki malzemelerden yemek fikirleri üretmek ve alışveriş listesini yönetmek için geliştirildi. Gemini entegrasyonu, PWA desteği ve alışveriş listesinde tahmini fiyat / ürün çıkarma akışları bulunuyor.',primary:['Canlı demoyu aç','https://yemek-fikirleri.vercel.app'],secondary:null},
  {icon:'KN',name:'Kalori Notu',status:'Live demo',group:'active',category:'Health Utility',availability:'Vercel production • canlı',summary:'Yemeğin fotoğrafından yaklaşık kalori tahmini yapmayı hedefleyen hızlı kayıt aracı.',desc:'Fotoğrafını çek, yaklaşık kalori bilgisini öğren ve günlük takibi kolaylaştır.',detail:'Mobil kullanım için geliştirilen AI destekli kalori takip aracı. Fotoğraf üzerinden yaklaşık kalori tahmini yaklaşımını hızlı, düşük sürtünmeli bir günlük kayıt deneyimine dönüştürmeyi hedefliyor.',primary:['Canlı demoyu aç','https://kalori-notu.vercel.app'],secondary:null},
  ...
  {icon:'PA',name:'P&ID Analyst',status:'Live demo',group:'active',category:'Engineering AI',availability:'Vercel production • canlı',summary:'P&ID PDF’lerini analiz edip ekipman, hat ve malzeme ilişkilerini daha hızlı incelemeye yardımcı olur.',desc:'P&ID PDF analizi ve malzeme listesi üretimi için geliştirilen mühendislik aracı.',detail:'React, Vite ve Express altyapısıyla P&ID PDF analizi ve material list generation akışlarını desteklemek üzere geliştirildi. Teknik doküman incelemesini ve ilk malzeme çıkarımını hızlandırmayı hedefliyor.',primary:['Canlı demoyu aç','https://pid-analist.vercel.app'],secondary:null},
  {icon:'RV',name:'Review Analyzer',status:'Live demo',group:'active',category:'Customer Insight',availability:'Vercel production • canlı demo',summary:'Müşteri yorumlarını toplu biçimde inceleyip tekrar eden sorunları ve ürün sinyallerini görünür hale getirir.',desc:'Manuel yorum metni veya demo ürün verisi üzerinden çalışan müşteri yorum analiz aracı.',detail:'Review Analyzer, ham müşteri yorumlarını yerel ayrıştırma ile analiz eder; manuel metin girişi ve demo ürün analizi akışlarını destekler. Amaç tekrar eden pain point, olumlu sinyal ve ürün geliştirme fırsatlarını hızlıca görünür hale getirmektir.',primary:['Canlı demoyu aç','https://proof-coral-two.vercel.app'],secondary:null},
