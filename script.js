const products = [
  {icon:'SR',name:'ShipReady',status:'Live demo',group:'active',category:'Marine Operations',availability:'Vercel production • canlı',summary:'Teknik ekiplerin proje hazırlığı ve operasyon takibini tek yerde hızlandırır.',desc:'Yacht / shipbuilding ekipleri için teknik hazırlık ve proje operasyon çözümü.',detail:'Teknik ekiplerin proje hazırlığı, doküman takibi ve operasyon akışını hızlandırmak için geliştirilen marine odaklı ürün. Canlı production sürümü Vercel üzerinde çalışıyor.',primary:['Canlı demoyu aç','https://shipready-git-main-schoolflow-ai.vercel.app'],secondary:null},
